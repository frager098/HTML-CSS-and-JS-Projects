...
function saveEditedContent(item,svgs,index){
    ...
    if(editedTransaction.transactionType == "income"){
        ...
        console.log(state,"Undoing old--income")
    }
    else{
        updateExpense(-editedTransaction.transactionAmount)
        console.log(state,"Undoing old--expense")
    }
...
let deleteSvg = ` <svg class="svg__delete" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 640 640">
                <title>Delete</title>
...
`
let editSvg = `<svg class="svg__edit" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 640 640"><!--!Font Awesome Free v7.0.0 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license/free Copyright 2025 
            Fonticons, Inc.-->
            <title>Edit</title>
...
let tickSvg = `<svg class="svg__tick" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 640 640">'
<title>cross</title>
