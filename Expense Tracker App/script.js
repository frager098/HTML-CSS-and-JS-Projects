...
function handleDelete(e){
    ...
    // console.log(target.id,target,"Debug")
...
function createListItem(){
    ...
    <li class="row list__item" data-id="${transactions[transactions.length - 1 ].id}">
        ...
        <div class="svg__container row">  
            ...
            <svg title="Edit" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 640 640"><!--!Font Awesome Free v7.0.0 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license/free Copyright 2025 
            Fonticons, Inc.-->
            <title>Edit</title>
